...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback, ConnectionCallbacks,
    ...
    private void showAlert() {
        ...
        dialog.setTitle("Enable Location")
                .setMessage("Your Locations settings is set OFF. \n" +
    ...
    public void onLocationChanged(@NonNull Location location) {
        ...
        mem.setLatitude(location.getLatitude());
        mem.setLongitude(location.getLongitude());
        ...
        mRootRef.child(mAuth.getCurrentUser().getUid()).child("LocationInformation").updateChildren(map).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
